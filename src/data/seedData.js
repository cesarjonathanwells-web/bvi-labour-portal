...
const businessUsers = [
  ...
  { id: 'biz-003', email: 'peter@islandtech.vg', password: 'test123', portal: 'business', role: 'employer', firstName: 'Peter', lastName: 'Thompson', organization: 'Island Tech Solutions', tradeLicense: 'TL-2025-0033', industry: 'Information Technology', island: 'Virgin Gorda', phone: '284-555-0103', createdAt: '2025-01-10T10:00:00Z' },
];
...
const workerUsers = [
  ...
  { id: 'wrk-003', email: 'raj.patel@email.com', password: 'test123', portal: 'worker', role: 'employee', firstName: 'Raj', lastName: 'Patel', nationality: 'India', currentEmployer: 'Island Tech Solutions', permitNumber: 'WP-2025-1003', phone: '284-555-0203', createdAt: '2025-02-01T10:00:00Z' },
];

// ── MOCK JOB SEEKER USERS ────────────────────────────────────────────
const jobSeekerUsers = [
  { id: 'js-001', email: 'tamara.penn@email.vg', password: 'test123', portal: 'jobseeker', role: 'jobseeker', firstName: 'Tamara', lastName: 'Penn', belongerStatus: 'Virgin Islander', skills: 'Customer service, Microsoft Office, Event planning', educationLevel: 'Associate Degree', phone: '284-555-0301', createdAt: '2025-01-20T10:00:00Z' },
  { id: 'js-002', email: 'david.frett@email.vg', password: 'test123', portal: 'jobseeker', role: 'jobseeker', firstName: 'David', lastName: 'Frett', belongerStatus: 'Belonger', skills: 'Carpentry, Electrical, Plumbing', educationLevel: 'High School Diploma', phone: '284-555-0302', createdAt: '2025-02-05T10:00:00Z' },
];
...
// ── MOCK DISPUTES ────────────────────────────────────────────────────
const disputes = [
  { id: 'dsp-001', caseNumber: 'DC-2025-4001', userId: 'wrk-002', status: 'investigating', type: 'unpaid_wages', complainantName: 'Anika James', respondentName: 'BVI Builders Corp', respondentAddress: 'Wickham Cay, Road Town', respondentPhone: '284-555-0102', description: 'Employer has not paid overtime wages for the months of January and February 2025. Total owed approximately $3,200 for 80 hours of overtime at 1.5x rate.', incidentDate: '2025-02-28', desiredResolution: 'Full payment of overtime owed plus interest', filedAt: '2025-03-05T10:00:00Z', updatedAt: '2025-03-18T10:00:00Z', assignedTo: 'dept-disputes-001', priority: 'high', timeline: [{ status: 'filed', date: '2025-03-05T10:00:00Z', note: 'Dispute filed' }, { status: 'investigating', date: '2025-03-10T10:00:00Z', note: 'Assigned to Dispute Officer. Employer contacted for response.' }] },
  { id: 'dsp-002', caseNumber: 'DC-2025-4002', userId: 'wrk-001', status: 'mediation', type: 'unfair_dismissal', complainantName: 'Carlos Garcia', respondentName: 'Previous Employer Ltd', respondentAddress: 'Main Street, Road Town', respondentPhone: '284-555-9999', description: 'Was terminated without proper notice or written reason as required under Section 81 of the Labour Code.', incidentDate: '2025-01-15', desiredResolution: 'Compensation for unfair dismissal and notice period', filedAt: '2025-01-20T10:00:00Z', updatedAt: '2025-03-01T10:00:00Z', assignedTo: 'dept-disputes-001', priority: 'medium', timeline: [{ status: 'filed', date: '2025-01-20T10:00:00Z', note: 'Dispute filed' }, { status: 'investigating', date: '2025-01-28T10:00:00Z', note: 'Investigation commenced' }, { status: 'mediation', date: '2025-02-15T10:00:00Z', note: 'Parties agreed to mediation. Session scheduled.' }] },
...
// ── MOCK JOBS ────────────────────────────────────────────────────────
const jobs = [
  { id: 'job-001', jobNumber: 'JV-2025-5001', employerId: 'biz-001', employerName: 'Tropic Resorts Ltd', title: 'Restaurant Manager', category: 'Hospitality & Tourism', description: 'Manage daily restaurant operations, supervise staff, ensure guest satisfaction, coordinate with kitchen team.', requirements: 'Minimum 3 years management experience, food safety certification, strong leadership skills.', salaryMin: 35000, salaryMax: 45000, workingHours: '40 hours/week', island: 'Tortola', employmentType: 'full-time', deadline: '2025-04-30', belongerPreferred: true, contactPerson: 'John Richards', contactEmail: 'john@tropicresorts.vg', contactPhone: '284-555-0101', status: 'open', applicants: 3, postedAt: '2025-03-01T10:00:00Z' },
  { id: 'job-002', jobNumber: 'JV-2025-5002', employerId: 'biz-002', employerName: 'BVI Builders Corp', title: 'Electrician', category: 'Construction & Engineering', description: 'Install and maintain electrical systems in residential and commercial buildings across the Territory.', requirements: 'Licensed electrician, 2+ years experience, own tools preferred.', salaryMin: 28000, salaryMax: 38000, workingHours: '45 hours/week', island: 'Tortola', employmentType: 'full-time', deadline: '2025-05-15', belongerPreferred: true, contactPerson: 'Maria Santiago', contactEmail: 'maria@bvibuilders.vg', contactPhone: '284-555-0102', status: 'open', applicants: 1, postedAt: '2025-03-10T10:00:00Z' },
  { id: 'job-003', jobNumber: 'JV-2025-5003', employerId: 'biz-003', employerName: 'Island Tech Solutions', title: 'IT Support Technician', category: 'Information Technology', description: 'Provide technical support to clients, troubleshoot hardware/software issues, manage network infrastructure.', requirements: 'CompTIA A+ or equivalent, networking knowledge, customer service oriented.', salaryMin: 25000, salaryMax: 35000, workingHours: '40 hours/week', island: 'Virgin Gorda', employmentType: 'full-time', deadline: '2025-04-15', belongerPreferred: false, contactPerson: 'Peter Thompson', contactEmail: 'peter@islandtech.vg', contactPhone: '284-555-0103', status: 'open', applicants: 0, postedAt: '2025-03-20T10:00:00Z' },
  { id: 'job-004', jobNumber: 'JV-2025-5004', employerId: 'biz-001', employerName: 'Tropic Resorts Ltd', title: 'Front Desk Receptionist', category: 'Hospitality & Tourism', description: 'Greet and check in guests, handle reservations, answer phone inquiries, provide concierge services.', requirements: 'High school diploma, customer service experience, computer literate, bilingual a plus.', salaryMin: 20000, salaryMax: 26000, workingHours: '40 hours/week, shifts', island: 'Tortola', employmentType: 'full-time', deadline: '2025-04-20', belongerPreferred: true, contactPerson: 'John Richards', contactEmail: 'john@tropicresorts.vg', contactPhone: '284-555-0101', status: 'open', applicants: 5, postedAt: '2025-03-05T10:00:00Z' },
];

// ── MOCK APPLICATIONS ────────────────────────────────────────────────
const applications = [
  { id: 'app-001', jobId: 'job-001', userId: 'js-001', applicantName: 'Tamara Penn', status: 'shortlisted', coverLetter: 'I have 5 years of experience in hospitality management and am passionate about delivering excellent service.', salaryExpectation: 40000, availableDate: '2025-05-01', appliedAt: '2025-03-05T10:00:00Z' },
  { id: 'app-002', jobId: 'job-004', userId: 'js-001', applicantName: 'Tamara Penn', status: 'submitted', coverLetter: 'I am interested in the receptionist position and have strong customer service skills.', salaryExpectation: 24000, availableDate: '2025-04-15', appliedAt: '2025-03-12T10:00:00Z' },
  { id: 'app-003', jobId: 'job-002', userId: 'js-002', applicantName: 'David Frett', status: 'interview', coverLetter: 'Licensed electrician with 8 years of residential and commercial experience in the BVI.', salaryExpectation: 35000, availableDate: '2025-04-01', appliedAt: '2025-03-15T10:00:00Z' },
];
...
const documents = [
  ...
  { id: 'doc-005', userId: 'js-001', type: 'resume', label: 'Resume - Tamara Penn', fileName: 'tamara_penn_resume.pdf', fileSize: 150000, uploadedAt: '2025-01-22T10:00:00Z' },
];
...
const notifications = [
  ...
  { id: 'ntf-003', userId: 'biz-001', message: 'Work permit WP-2024-1001 for Carlos Garcia expires in 30 days. Please submit a renewal application.', type: 'warning', read: false, createdAt: '2025-03-10T10:00:00Z' },
  { id: 'ntf-004', userId: 'wrk-002', message: 'Your dispute DC-2025-4001 status has been updated to: Investigating.', type: 'info', read: false, createdAt: '2025-03-10T10:00:00Z' },
  { id: 'ntf-005', userId: 'biz-003', message: 'Work permit WP-2025-1003 for Raj Patel is under review.', type: 'info', read: false, createdAt: '2025-03-20T10:00:00Z' },
  { id: 'ntf-006', userId: 'js-001', message: 'Your application for Restaurant Manager at Tropic Resorts Ltd has been shortlisted!', type: 'success', read: false, createdAt: '2025-03-08T10:00:00Z' },
