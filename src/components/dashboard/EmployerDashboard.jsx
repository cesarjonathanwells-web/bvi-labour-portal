...
export default function EmployerDashboard() {
  ...
  const quickActions = [
    { label: 'New Permit Application', icon: Plus, onClick: () => navigate('/business/permits/apply/new'), primary: true },
    { label: 'Renew Permit', icon: RefreshCw, onClick: () => navigate('/business/permits/apply/renewal'), primary: false },
                    ...
                    return (
                      <div key={p.id} className="flex items-center justify-between bg-white/10 backdrop-blur rounded-lg px-4 py-2.5">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            onClick={() => navigate('/business/permits/apply/renewal')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
              ...
              <button
                onClick={() => navigate('/business/permits/status')}
            ...
            {activePermits.length > 0 ? (
              ...
              <div className="px-6 py-12 text-center text-gray-400">
                ...
                <button
                  onClick={() => navigate('/business/permits/apply/new')}
